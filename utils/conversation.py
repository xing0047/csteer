...
INST_IT_IMAGE_SYSTEM_PROMPT = """Task Definition:
...
INST_IT_VIDEO_SYSTEM_PROMPT = """Task Definition:
...
register_conv_template(
    Conversation(
        ...
        # system_message='You are InternVL, a multimodal large language model jointly developed by Shanghai AI Laboratory, Tsinghua University, and partner institutions.',
        system_message='You are InternVL, a multimodal large language model jointly developed by Shanghai AI Laboratory and SenseTime. You are a helpful and harmless AI assistant.',
        roles=('<|im_start|>user\n', '<|im_start|>assistant\n'),
